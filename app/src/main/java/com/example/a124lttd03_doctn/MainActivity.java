package com.example.a124lttd03_doctn;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void XuLyMoManHinhTinNhan() {
        if(ActivityCompat.checkSelfPermission(this, android.Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED)
        {
            ...
            intent.setClassName("com.example.a124lttd03_doctn","com.example.a124lttd03_doctn.DocTinNhan");
    ...
    private void XuLyMoManHinhDanhBa() {
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED)
        {
            ...
            intent.setClassName("com.example.a124lttd03_doctn","com.example.a124lttd03_doctn.DanhBa");
            startActivity(intent);
        }
